...
describe('looseEqual', () => {
  test('compare booleans correctly', () => {
  ...
  test('compare strings correctly', () => {
  ...
  test('compare numbers correctly', () => {
    const number = 100
    const decimal = 2.5
  ...
  test('compare sparse arrays correctly', () => {
    const arr1: any[] = []
    arr1[2] = true
    const arr2: any[] = []
    arr2[2] = true
    const arr3: any[] = [false, false, true]
    const arr4: any[] = [undefined, undefined, true]
    const arr5: any[] = []
    arr5[0] = arr5[2] = true
